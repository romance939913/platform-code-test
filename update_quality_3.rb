...
# require_relative './oop/blue_star'
...
#     when 'Blue Star'        
#       new_award = BlueStar.new(award[:name], award[:expires_in], award[:quality])
#     else
...
# blue_star = { name: 'Blue Star', expires_in: 8, quality: 20 }

# puts update_quality([brennan, blue_first, blue_compare, blue_star])